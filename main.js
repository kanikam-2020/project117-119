...
random_number = Math.floor((Math.random() * quick_draw_data_set.length) + 1);//To access the random sketch from the array, 
//you can use the Math.floor() function
console.log(quick_draw_data_set[random_number]);
sketch = quick_draw_data_set[random_number];//Then, to access the elements from the array, by passing the random_no
...
{
  timer_counter++;//time is incrementing by 1
  document.getElementById('time').innerHTML = 'Timer: ' + timer_counter;
  console.log(timer_counter)
  if(timer_counter > 400)
    {
      timer_counter = 0;
      timer_check = "completed"//means time is complete
    }
